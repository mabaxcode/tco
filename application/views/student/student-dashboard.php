...
<html lang="en">
	...
	<!-- Header -->
	<?php $this->load->view('masterUI/header'); ?>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="<?= base_url(); ?>"><font size="2" color="white"><strong>Tuition Centre Organizer</strong></font></a>
						<!--end::Logo-->
						<!--begin::Toggle-->
						<?/*
					...
					<!--end::Brand-->
					<!--begin::Aside Menu-->
					<?php $this->load->view('student/student-menu'); ?>
					<!--end::Aside Menu-->
				</div>
				<!--end::Aside-->
				<!--begin::Wrapper-->
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center">
									...
									<span class="text-primary font-size-base font-weight-bolder"><?= display_current_dt(); ?></span>
									<!--end::Daterange-->
								</div>
								<!--end::Toolbar-->
							</div>
					...
					<!--end::Content-->
					<!--begin::Footer-->
					<?php $this->load->view('masterUI/footer'); ?>
					<!--end::Footer-->
				</div>
				<!--end::Wrapper-->
			</div>
		...
		<!--end::Main-->
		<!-- begin::User Panel-->
		<?php $this->load->view('masterUI/user-panel'); ?>
		<!-- end::User Panel-->
		<?php $this->load->view('masterUI/scrolltop'); ?>

		<?php $this->load->view('masterUI/script'); ?>
