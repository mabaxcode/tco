			...
			<div class="card card-custom card-stretch gutter-b">
				...
				<div class="card-header border-0 pt-5">
					<h3 class="card-title align-items-start flex-column">
						...
						<span class="text-muted mt-3 font-weight-bold font-size-sm">You have an ongoing class</span>
					</h3>
				</div>
				<!--end::Header-->
				<!--begin::Body-->
				<div class="card-body pt-8 pb-0 mt-n3">
						<!--begin::Nav-->
				...
				<div class="card-body pt-8 pb-0 mt-n3">
					<div class="alert alert-custom alert-notice alert-light-primary fade show" role="alert">
						...
						<div class="alert-text font-size-h6"><b>Ops ! </b>You dont have any Tuition yet.</div>
					</div>
				</div>
