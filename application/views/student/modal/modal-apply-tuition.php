<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
	<div class="modal-content">
		...
		<form class="form" id="subject-form-data">
					...
					<div class="col-lg-10 col-md-10 col-sm-12">
						<select class="form-control select2" id="kt_select_subject" name="subjects[]" multiple="multiple" required="">
							<? foreach ($subjects as $subject) { ?>
									<option value="<?= $subject['code']?>"><?= $subject['descs']?></option>
							<? } ?>
						</select>
					</div>
				</div>
		...
		<div class="modal-footer">
			...
			<button type="button" class="btn btn-primary mr-2 submit-payment-tuition">Submit to payment</button>
		</div>
	</div>
</div>
