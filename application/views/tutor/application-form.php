				...
				<div class="card-body px-0">
					<div class="tab-content pt-5">
						...
						<div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
							...
							<?php echo form_open_multipart('tutor/submit_application');?>
								<!--begin::Heading-->
								<div class="row">
									<div class="col-lg-9 col-xl-6 offset-xl-3">
										<h3 class="font-size-h6 mb-5">Tutor Info:</h3>
									</div>
								</div>
								<!--end::Heading-->
								...
								<div class="form-group row">
									<label class="col-xl-3 col-lg-3 text-right col-form-label">* Apply For Subject ?</label>
									<div class="col-lg-9 col-xl-6">
										<select name="subject" class="form-control form-control-lg">
												<option value="">[Please Select]</option>
												<? foreach ($subject as $key) { ?>
														<option value="<?= $key['code']?>"><?= $key['descs']?></option>
												<? } ?>
										</select>
									</div>
								</div>
								...
								<!--end::Heading-->
								<div class="form-group row">
									<label class="col-xl-3 col-lg-3 text-right col-form-label">Resume</label>
									<div class="col-lg-9 col-xl-6">
										<a href="#" class="btn btn-sm btn-primary upload-tutor-doc">Upload Resume</a>
										<div id="load-resume-doc">
											<? if($resume_doc): ?>
												<div class="alert alert-secondary mt-2" role="alert">
												    <a href="#" class="alert-link"><?= $resume_doc['original_filename']?></a>
												    <? if($resume_doc['is_submit'] == 0){ ?>
													    <a href="#" class="close delete-tutor-doc" data-init="<?= $resume_doc['id']?>"><i class="ki ki-close icon-nm"></i></a>
													<? } ?>
												</div>
											<? endif; ?>
										</div>
