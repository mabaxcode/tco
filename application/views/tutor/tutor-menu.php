	...
	<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
		...
		<ul class="menu-nav">
			...
			<li class="menu-item" aria-haspopup="true">
				<a href="<?= base_url('tutor/manage_timetable'); ?>" class="menu-link">
					...
					<span class="menu-text">Manage Timetable</span>
				</a>
			</li>
			<li class="menu-item" aria-haspopup="true">
				<a href="<?= base_url('tutor/my_student'); ?>" class="menu-link">
			...
			<li class="menu-item menu-item-submenu menu-item-open" aria-haspopup="true" data-menu-toggle="hover">
				...
				<div class="menu-submenu">
					...
					<ul class="menu-subnav">
						<li class="menu-item" aria-haspopup="true">
							<a href="<?= base_url('tutor/create_homework') ?>" class="menu-link">
								<i class="menu-bullet menu-bullet-dot">
									<span></span>
								</i>
								<span class="menu-text">Create Homework</span>
							</a>
						</li>
						<li class="menu-item" aria-haspopup="true">
							<a href="layout/themes/header-dark.html" class="menu-link">
								...
								<span class="menu-text">Student's Homework</span>
							</a>
						</li>
					</ul>
				</div>
			...
			<li class="menu-item" aria-haspopup="true">
				<a href="<?= base_url('tutor/student_material'); ?>" class="menu-link">
			...
			<li class="menu-item" aria-haspopup="true">
				<a href="#" class="menu-link">
					...
					<span class="menu-text">Student Quiz</span>
				</a>
			</li>
			*/?>
