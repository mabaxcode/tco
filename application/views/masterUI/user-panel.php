	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="symbol symbol-100 mr-5">
				...
				<div class="symbol-label" style="background-image:url('<?= view_profile_picture($picture_data)?>')"></div>
				<? else: ?>
			...
			<div class="d-flex flex-column">
				<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?=$this->session->userdata('name')?></a>
